...
custom_imports = dict(
    imports=[
        ...
        'codes.models.dual_resnet_spatial' # Loads our new spatial attention module
    ],
...
model = dict(
    data_preprocessor=dict(
        ...
        pad_size_divisor=32),
    backbone=dict(
        type='DualResNetSpatial', # Custom spatial attention network backbone class
        depth=50,
        out_indices=(0, 1, 2, 3),
        frozen_stages=1,
        style='pytorch'),
...
work_dir = './work_dirs/rgbt_spatial_fusion_cascade'